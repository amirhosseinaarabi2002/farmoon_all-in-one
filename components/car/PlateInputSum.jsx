...
// import {
//   ViolationResponse,
//   ViolationSumResponse,
// } from "@/models/carViolationResponse";
...
import { getCarViolationSum } from "@/api/car/inquiryNoAuth_api";
import { ViolationSumResponse } from "@/model/carViolationResponse";
...
const CarPlateInputSum = () => {
  ...
  const { isOpen: isTotalViolationModalOpen, onOpen: onTotalViolationModalOpen, onOpenChange: onTotalViolationModalOpenChange } = useDisclosure();

  useEffect(() => {
    const savedData = JSON.parse(
      localStorage.getItem("carViolationSumFormData")
    );
    if (savedData) {
  ...
  const getViolationSubmit = async (data) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        localStorage.removeItem("carViolationSumFormData");
        Cookies.set("natCodeSumCar", "1490009078", {
          secure: false,
          sameSite: "lax",
        });
    ...
    <div className="flex justify-center items-center gap-x-10 flex-col md:flex-row">
      ...
      >
        ...
        <div className="car-plate-container flex flex-row-reverse justify-center items-center mb-5 w-[340px]">
          ...
          <input
            ...
            placeholder="_ _"
            inputMode="numeric" // This shows numeric keyboard on mobile
            onInput={(e) => handleNumberInput(e, 2)} // Added input handler
          ...
          <input
            ...
            placeholder="_ _ _"
            inputMode="numeric" // This shows numeric keyboard on mobile
            onInput={(e) => handleNumberInput(e, 3)} // Added input handler
            className="plate-input mr-2 font-DanaDemiBold w-12 h-12 text-center border-none outline-none bg-gray-100 rounded-lg"
          />
          <input
            size="lg"
                ...
                <ModalBody>
                  <div>
                    ...
                    <p className="font-Kalame text-center font-semibold my-3">
                      ...
                      {violationPrice?.naji_price?.toLocaleString("fa-IR") ?? "۰"} تومان
                      می باشد
                    </p>
                    <Button
                      size="lg"
                    ...
                    >
                      {isChargingWallet ? (
                        ...
                        <span>
                          افزایش اعتبار{" "}
                          {violationPrice?.naji_price?.toLocaleString("fa-IR") ?? "۰"}{" "}
                    ...
                    >
                      {isChargingWallets ? (
                        ...
                        <span>
                          افزایش اعتبار{" "}
                          {(violationPrice.naji_price * 2).toLocaleString("fa-IR")}{" "}
                ...
                <ModalBody>
                  <div className="dialog-content p-5">
                    ...
                    <p className="font-Kalame text-center mb-3">
                      اگر به اطلاعات مالک دسترسی ندارید، میتوانید از استعلام خلافی مجموع بدون نیاز به کدملی استفاده کنید
                    </p>
      ...
      <div className="mt-8">
        <h1 className="md:text-lg font-KalameBold mb-4 mx-2 lg:mr-20">
          گرفتن رایگان مجموع خلافی خودرو با پلاک و خلافی خودرو (رایگان)
        </h1>
