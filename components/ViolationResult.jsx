...
const ViolationResult = () => {
  ...
  return (
    <div className="div-result-container">
            ...
            {bill.type === "دوربین" ? (
              ...
              >
                {loadingStates[index] ? (
                  ...
                  <span>
                    تصویر {"("}{" "}
                    {(violationPrice?.image_price || 0).toLocaleString("fa-IR")}{" "}
                    تومان {")"}
                  </span>
                )}
              </Button>
      ...
      {/* Unified Modal for both image and payment */}
      <Modal
                ...
                {activeModalType === "image" && imageUrl ? (
                  ...
                  <div>
                    ...
                    <p className="font-Kalame text-center font-semibold my-3">
                      هزینه ی استعلام عکس {violationPrice?.image_price || 0}{" "}
                      تومان می باشد
                    </p>
                    <Button
                      size="lg"
                    ...
                    >
                      {isChargingWallet ? (
                        ...
                        <span className="text-sm">
                          افزایش اعتبار {violationPrice?.image_price || 0} تومان{" "}
                          {"("} یک بار استعلام عکس {")"}
                        </span>
                      )}
                    </Button>
