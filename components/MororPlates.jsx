...
import { getCarPlates } from "@/api/getPlates_api";
...
const CarPlates = ({ onPlateClick }) => {
  ...
  return (
    <div className="block">
      <div className="overflow-auto max-h-40 font-Kalame font-bold px-2">
        {plates.length === 0 ? (
          ...
          plates.map((plate) => (
            ...
            >
              <div dir="ltr" className="flex flex-row justify-between text-sm items-center">
                <div className="flex flex-row items-center bg-white p-1.5 rounded-sm">
                  ...
                  <div className="flex flex-col gap-y-0.5">
                    ...
                    <div className="plate-number-item">
                      <span>{plate.plateInfo.digit5} </span>
                    </div>
                  </div>
                  <span className="plate-number-item text-xs text-gray-400 font-thin rotate-90 ml-2">
                    ایران
                  </span>
                </div>
                
                <div className="flex items-center gap-2">
                  <div dir="rtl" className="flex flex-col gap-y-1">
          ...
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
                <h3 className="text-lg font-Kalame font-semibold">حذف پلاک موتور</h3>
              </ModalHeader>
              <ModalBody>
                <div className="">
                  <p className="font-Kalame text-center mb-4">
                    آیا از حذف این پلاک موتور اطمینان دارید؟
                  </p>
